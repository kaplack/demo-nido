    ...
    <div className="nido-demo">
      <div className="demo-strip">
        ...
        <div className="demo-strip-actions">
          ...
          <a
            className="strip-contact"
            href="mailto:contacto@alanburga.com?subject=Quiero%20una%20web%20de%20matrícula%20para%20mi%20nido"
            aria-label="Contactar por correo"
            title="Correo"
          >✉</a>
          <a
            className="strip-contact whatsapp"
